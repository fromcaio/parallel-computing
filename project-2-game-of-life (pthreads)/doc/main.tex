...
\usepackage{longtable}        % Para tabelas que se estendem por várias páginas
...
\titulo{Parallel Conway's Game of Life Using Pthreads}
\autor{Caio Reis}
...
\preambulo{Trabalho de Conclusão de Curso apresentando implementações sequencial e paralela (Pthreads) do Jogo da Vida de Conway, com análise de desempenho em ambiente de memória compartilhada.}
